<div>
    ...
    <div class="row align-items-center justify-content-between mb-4">
        <div class="col">
            <h5 class="fw-500 text-white">Edit Stock Entry</h5>
        </div>
        <div class="col-auto">
            ...
            <div class="card mb-4">
                <div class="card-header p-4">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <select type="text" class="form-control" wire:model="staff_id">
                ...
                <div class="row align-items-center px-4 mb-3">
                    ...
                    <div class="col-auto">
                        ...
                        <button type="submit" class="btn btn-primary mb-0" wire:click.prevent="save">Update Entry</button>
                    </div>
                </div>
            </div>
        </div>
