<div>
    ...
    <div class="row align-items-center justify-content-between mb-4">
        <div class="col">
            <h5 class="fw-500 text-white">Edit Purchase</h5>
        </div>
        <div class="col-auto">
            ...
            <div class="card mb-4">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto">
                                    <button type="button" class="btn btn-primary mb-0" data-bs-toggle="modal" data-bs-target="#addsupplier">
                        ...
                        <div class="col-md-2">
                            <input type="number" class="form-control" wire:model="discount" placeholder="Discount Amount">
                        </div>
                        <div class="col-md-10">
                        ...
                        <div class="col-md-2">
                            <input type="number" wire:model="service_charge" class="form-control" placeholder="Service Charge">
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table align-items-center mb-3">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="">
                                        <p class="text-sm px-3 mb-0">${{$total[$key]}}</p>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
                ...
                <div class="row align-items-center px-4 mb-3">
                    ...
                    <div class="col-auto">
                        ...
                        <button type="submit" class="btn btn-primary mb-0" wire:click.prevent="savePurchase">Update Purchase</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title fw-600" id="addsupplier">Add Supplier</h6>
