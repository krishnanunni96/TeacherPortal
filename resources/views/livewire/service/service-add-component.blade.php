<div>
    ...
    <div class="row align-items-center justify-content-between mb-4">
        <div class="col">
            <h5 class="fw-500 text-white">Add Service</h5>
        </div>
        <div class="col-auto">
                            ...
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                    {{-- <tr>
                                        ...
                                        <td>
                                            <select class="form-select" wire:model="type_name.{{0}}" style="width: 350px;">
                                        ...
                                        <td class="align-middle text-center">
                                            <input type="text" class="form-control @error('price') is-invalid @enderror" wire:model="price.{{0}}" style="width: 150px;">
                                            @error('price')
                                                <span class="invalid-feedback">{{$message}}</span>
                                            @enderror
                                        </td>
                    ...
                    <div class="card-footer p-2 mx-2">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div>
                                ...
                                <button type="submit" wire:click.prevent="save" class="btn btn-primary ms-4">Submit</button>
                            </div>
                        </div>
                    </div>
                </form>
